 ...
 *            initiates and triggers the measurement system of the APS, 
 *            fetch measurement results and displays a message pop-up dialog.
 *
...
int main (void)
{
    ...
    checkErr (agn6k7kni_ConfigureAcqTriggerSource (agn6k7kni, "1", AGN6K7KNI_VAL_SOFTWARE_TRIG));
    
    
    /*- Initiate and trigger the aquisition system ---------------------------------------------------*/  
    checkErr (agn6k7kni_InitiateAcquisition (agn6k7kni, "1"));
    
    while (!wtgState) agn6k7kni_QueryAcquisitionWtgState(agn6k7kni, "1", &wtgState);
    
    checkErr (agn6k7kni_SendAcquisitionTrigger(agn6k7kni, "1"));
    ...
    /*  Average Current (DC) */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_CURRENT_DC, &averageCurrent));
    /*  RMS Current (AC + DC) */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_CURRENT_RMS, &rmsCurrent));
    /*  High Level Of Current Pulse */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_CURRENT_HIGH, &highCurrent));
    /*  Low Level Of Current Pulse  */   
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_CURRENT_LOW, &lowCurrent)); 
    /*  Maximum Current */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_CURRENT_MAX, &maxCurrent));
    /*  Minimum Current */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_CURRENT_MIN, &minCurrent));
    /*  Average Voltage (DC) */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_VOLTAGE_DC, &averageVoltage));
    /*  RMS Voltage (AC + DC) */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_VOLTAGE_RMS, &rmsVoltage));
    /*  High Level Of Voltage Pulse */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_VOLTAGE_HIGH, &highVoltage));
    /*  Low Level Of Voltage Pulse */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_VOLTAGE_LOW, &lowVoltage));
    /*  Maximum Voltage */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_VOLTAGE_MAX, &maxVoltage)); 
    /*  Minimum Voltage */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_VOLTAGE_MIN, &minVoltage));
    /*  Average Power */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_POWER_DC, &averagePower));
    /*  Amp-Hour */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_AHO, &ampHour));
    /*  Watt-Hour */
    checkErr (agn6k7kni_Fetch (agn6k7kni, "1", 5000, AGN6K7KNI_VAL_MEAS_TYPE_WHO, &wattHour));
