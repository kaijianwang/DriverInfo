...
int main ()
{
    ...
    checkErr( tkafg3k_ConfigureOutputImpedance (tkafg3k, "1", 50));

    /* Configures the arbitrary waveform */
    checkErr( tkafg3k_ConfigureArbWaveform (tkafg3k, "1", iArbWfmHandle, 0.5, 0));
    checkErr( tkafg3k_ConfigureArbFrequency (tkafg3k, "1", TKAFG3K_VAL_OUTPUT_FUNC)); 
