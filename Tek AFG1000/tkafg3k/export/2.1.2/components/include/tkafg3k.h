 ...
 *                                                                          
 * Title:    tkafg3k.h                                        
 * Purpose:  Tektronix AFG3000 Series Arbitrary Function Generator                                       
 ...
 ****************************************************************************/
#define TKAFG3K_MAJOR_VERSION                2     	/* Instrument driver major version   */
#define TKAFG3K_MINOR_VERSION                1    	/* Instrument driver minor version   */
...
#define TKAFG3K_SUPPORTED_INSTRUMENT_MODELS  "AFG3021,AFG3022,AFG3021B,AFG3022B,AFG3101,AFG3102,AFG3251,AFG3252"
...
ViStatus _VI_FUNC tkafg3k_ConfigureOutputMode (ViSession vi, ViInt32 outputMode);
...
ViStatus _VI_FUNC  tkafg3k_ConfigureSampleRate (ViSession vi, ViReal64 sampleRate);
...
ViStatus _VI_FUNC  tkafg3k_ClearArbWaveformBySlot (ViSession vi, ViInt32 slot);
...
ViStatus _VI_FUNC tkafg3k_ConfigureInternalTriggerRate (ViSession vi, ViReal64 rate);

	/*- External Triggering -------------------------------------------------*/
	
ViStatus _VI_FUNC tkafg3k_ConfigureExternalTriggerSlope (ViSession vi, ViInt32 triggerSlope);
...
ViStatus _VI_FUNC  tkafg3k_GetAttributeViInt32 (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 *value);
ViStatus _VI_FUNC  tkafg3k_GetAttributeViReal64 (ViSession vi, ViConstString channelName, ViAttr attribute, ViReal64 *value);
ViStatus _VI_FUNC  tkafg3k_GetAttributeViString (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 bufSize, ViChar value[]); 
ViStatus _VI_FUNC  tkafg3k_GetAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attribute, ViSession *value);
ViStatus _VI_FUNC  tkafg3k_GetAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attribute, ViBoolean *value);

ViStatus _VI_FUNC  tkafg3k_SetAttributeViInt32 (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 value);
ViStatus _VI_FUNC  tkafg3k_SetAttributeViReal64 (ViSession vi, ViConstString channelName, ViAttr attribute, ViReal64 value);
ViStatus _VI_FUNC  tkafg3k_SetAttributeViString (ViSession vi, ViConstString channelName, ViAttr attribute, ViConstString value); 
ViStatus _VI_FUNC  tkafg3k_SetAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attribute, ViSession value);
ViStatus _VI_FUNC  tkafg3k_SetAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attribute, ViBoolean value);

ViStatus _VI_FUNC  tkafg3k_CheckAttributeViInt32 (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 value);
ViStatus _VI_FUNC  tkafg3k_CheckAttributeViReal64 (ViSession vi, ViConstString channelName, ViAttr attribute, ViReal64 value);
ViStatus _VI_FUNC  tkafg3k_CheckAttributeViString (ViSession vi, ViConstString channelName, ViAttr attribute, ViConstString value); 
ViStatus _VI_FUNC  tkafg3k_CheckAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attribute, ViSession value);
ViStatus _VI_FUNC  tkafg3k_CheckAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attribute, ViBoolean value);
