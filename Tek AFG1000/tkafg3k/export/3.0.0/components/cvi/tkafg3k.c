 ...
 *      [Qizhen] October 12, 2005 - Add Create Arb Waveform by Slot fuctions to the driver. 
 *		[Clark Li] November 22, 2007 - Add new models AFG3021B and AFG3022B, update range tables for new models and firmwares.
 *		[Clark Li] December 24, 2007 - Add new model AFG3011, update range tables for new models and firmwares.
 *                                                                           
 *****************************************************************************/
...
/*- Frequency Range ---------------------------------------------------------*/
	/*- Maximum Frequency Value for model 3011 -*/
...
#define AFG302X_VAL_MAX_FREQ_ARB_IN_BURST			(6250000.00)
	...
	/*- Maximum Frequency Value for model 3101/3102 -*/
...
#define AFG310X_VAL_MAX_FREQ_ARB_IN_BURST			(25000000.00) 
	...
	/*- Maximum Frequency Value for model 3251/3252 -*/	
...
/*- Amplitude Range ---------------------------------------------------------*/
	/*- Maximum/Minimum Amplitude Value for model 3011 -*/
...
#define AFG3011_VAL_MIN_AMPL_IN_OPEN				(40.0e-3)
	...
	/*- Maximum/Minimum Amplitude Value for model 3021/3022/3021B/3022B -*/
...
#define AFG302X_VAL_MIN_AMPL_IN_OPEN				(20.0e-3)
	...
	/*- Maximum/Minimum Amplitude Value for model 3101/3102 -*/
...
#define AFG310X_VAL_MIN_AMPL_IN_OPEN				(40.0e-3)
	...
	/*- Maximum/Minimum Amplitude Value for model 3251/3252 -*/
...
#define AFG325X_VAL_MIN_AMPL_IN_OPEN				(100.0e-3)
	...
	/*- Maximum Amplitude Value for model 3251/3252 in high frequency -*/
...
/*- Offset Range ------------------------------------------------------------*/
	/*- Maximum/Minimum Offset Value for model 3011 -*/ 
...
#define AFG3011_VAL_MIN_OFFSET_IN_OPEN				(-20.0)
	...
	/*- Maximum/Minimum Offset Value for model 3021/3022/3021B/3022B -*/ 
...
#define AFG302X_VAL_MIN_OFFSET_IN_OPEN				(-10.0)
	...
	/*- Maximum/Minimum Offset Value for model 3101/3102 -*/ 
...
#define AFG310X_VAL_MIN_OFFSET_IN_OPEN				(-10.0)
	...
	/*- Maximum/Minimum Offset Value for model 3251/3252 -*/
...
#define AFG302X_VAL_MIN_PUL_WID						(30e-9)
...
#define AFG302X_VAL_MIN_PUL_EDGE_TIME				(18e-9)
...
#define AFG3021B_VAL_MAX_WFM_SIZE					131072
...
static ViStatus tkafg3k_VerifyWaveformByChannel	(ViSession vi, ViConstString channelName, ViInt32 waveform);

static ViStatus tkafg3k_CreateNewWaveform (ViSession vi, ViSession io, ViInt32 wfmSize, ViReal64 wfmData[], ViInt32 wfmHandle );
...
static ViStatus tkafg3k_VerifyWfmCreatable (ViSession vi, ViInt32 wfmSize, ViReal64 wfmData[]);

static ViStatus tkafg3k_VerifyWfmBySlotCreatable (ViSession vi, ViInt32 wfmSize, ViReal64 wfmData[]);
...
static ViStatus tkafg3k_GetSweepFrequencyRangeTable( ViSession vi, ViConstString channelName, IviRangeTablePtr *rangeTablePtr);
...
static ViStatus _VI_FUNC tkafg3kAttrDriverRevision_ReadCallback (ViSession vi, ViSession io, ViConstString channelName,
                                                                  ViAttr attributeId, const ViConstString cacheValue);
                                                                  
static ViStatus _VI_FUNC tkafg3kAttrInstrumentManufacturer_ReadCallback (ViSession vi, ViSession io, ViConstString channelName, 
                                                                          ViAttr attributeId, const ViConstString cacheValue);
                                                                          
static ViStatus _VI_FUNC tkafg3kAttrInstrumentModel_ReadCallback (ViSession vi, ViSession io, ViConstString channelName, 
                                                                   ViAttr attributeId, const ViConstString cacheValue);

static ViStatus _VI_FUNC tkafg3kAttrFirmwareRevision_ReadCallback (ViSession vi, ViSession io, ViConstString channelName, 
                                                                    ViAttr attributeId, const ViConstString cacheValue);
...
static ViStatus _VI_FUNC tkafg3kAttrFSKHopFrequency_RangeTableCallback (ViSession vi,
                                                                        ViConstString channelName,
                                                                        ViAttr attributeId,
                                                                        IviRangeTablePtr *rangeTablePtr);
 ...
 *           IviInit function.                                     
 *****************************************************************************/
ViStatus _VI_FUNC tkafg3k_InitWithOptions( ViRsrc resourceName, ViBoolean IDQuery,
    										ViBoolean resetDevice, ViConstString optionString, ViSession *newVi )
{   
    ViStatus    error = VI_SUCCESS;
                                    ...
                                    ViBoolean reset, ViSession vi)
{
	...
	if( (Ivi_Simulating(vi)) || (!IDQuery) )
	{
        ...
        checkErr( Ivi_GetAttributeViString (vi, VI_NULL, IVI_ATTR_DRIVER_SETUP, 
                                            0, rdBufferSize, rdBuffer));
        
		if (strstr(rdBuffer, "AFG3011"))
        {
        	model = TKAFG3K_VAL_MODEL_AFG3011;
        }
                                                  ...
                                                  ViReal64 trailingEdgeTime)
{
    ...
    dutyCycleHigh = 100*(period-0.8*(leadingEdgeTime+trailingEdgeTime))/period + 1.0e-14;
...
/*****************************************************************************
 * Function: tkafg3k_VerifyWaveformByChannel
 * Purpose:  This utility function verifies that the specified channel of the
 *			 instrument is currently in a specific waveform.  If the channel
 *			 is not in the correct waveform, the function returns the
 *           IVI_ERROR_INVALID_CONFIGURATION error.
 *****************************************************************************/
static ViStatus tkafg3k_VerifyWaveformByChannel	(ViSession vi, ViConstString channelName, ViInt32 waveform)
{
    ViStatus error = VI_SUCCESS; 
    ViInt32 actualWaveform;
    
    checkErr (Ivi_GetAttributeViInt32 (vi, channelName, TKAFG3K_ATTR_WAVEFORM, 0, &actualWaveform) );
    
    if(waveform != actualWaveform)
    {
    	ViInt32 actualElab;
    	ViChar	errElab[BUFFER_SIZE];
    	ViString errMode[17] = {
                                              ...
                                              ViReal64 wfmData[], ViInt32 wfmHandle )
{
    ...
    checkErr( Ivi_Alloc (vi, sizeof(ViInt16)*(wfmSize), (ViAddr *)(&binData)));
													  ...
													  ViReal64 endPointData, ViInt32 wfmHandle)
{
    ...
    data1 = 0x1FFF*(startPointData+1.0);
    data2 = 0x1FFF*(endPointData+1.0);
...
static ViStatus tkafg3k_CreateArbRecords (ViSession vi)
{
    ...
    checkErr( Ivi_Alloc (vi, sizeof(wfmNode)*maxNumWfms,  (ViAddr *)(&newWfmStruct)));
...
{
    ViStatus error = VI_SUCCESS;
    ViInt32 maxWfms, currentWfms, wfmQuantum, minWfmSize, maxWfmSize, i, compare;
...
{
    ViStatus error = VI_SUCCESS;
    ViInt32 currentWfms, wfmQuantum, minWfmSize, maxWfmSize, i, compare;		
...
{
    ViStatus error = VI_SUCCESS;
    ViInt32 currentWfms, wfmQuantum, minWfmSize, maxWfmSize, data1Compare, data2Compare;
...
{
    ViStatus error = VI_SUCCESS;
    ViInt32 maxWfms, currentWfms, wfmQuantum, minWfmSize, maxWfmSize, compare;
...
{
    ViStatus error = VI_SUCCESS;
    ViInt32 currentWfms, wfmQuantum, minWfmSize, maxWfmSize, compare;
		...
		if (!Ivi_Simulating (vi)) {
			...
			switch (model) {
				...
				case TKAFG3K_VAL_MODEL_AFG3021B:
					*wfmSize = AFG3021B_VAL_MAX_WFM_SIZE;
					break;
...
static ViStatus tkafg3k_DefaultInstrSetup (ViSession vi)
{
	...
	if (!clearArbData)
	{
    	...
    	if (!Ivi_Simulating(vi))
    	{
        	...
        	ViInt32     index, size, handle, scanCnt;
															  ...
															  IviRangeTablePtr *rangeTablePtr)
{
    ...
    switch	(waveform)
    {
    	case TKAFG3K_VAL_WFM_SINE:
    	{
    		...
    		else if( (model == TKAFG3K_VAL_MODEL_AFG3101) || (model == TKAFG3K_VAL_MODEL_AFG3102) )
    		{
    			tblPtr = &attrAFG310XSineWfmSweepFrequencyRangeTable;
    		}
    		else if( (model == TKAFG3K_VAL_MODEL_AFG3251) || (model == TKAFG3K_VAL_MODEL_AFG3252) )
    		{
    			tblPtr = &attrAFG325XSineWfmSweepFrequencyRangeTable;
    		}
			else if(model == TKAFG3K_VAL_MODEL_AFG3011)
    		{
...
static IviRangeTable attrAFG325XSineWfmInBurstFuncFrequencyRangeTable =
{
		...
		/* AFG3011, SINE waveform, Burst Mode */
...
{
        {TKAFG3K_VAL_MIN_FREQ, AFG302X_VAL_MAX_FREQ_DEFAULT, 0, "", 0},			/*- 1mHz ~ 1MHz -*/
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
{
        {TKAFG3K_VAL_MIN_FREQ, AFG325X_VAL_MAX_FREQ_DEFAULT, 0, "", 0},			/*- 1mHz ~ 1MHz -*/
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
                                                               ...
                                                               IviRangeTablePtr *rangeTablePtr)    
{
    ...
    switch	(waveform)
    {
    	...
    	case TKAFG3K_VAL_WFM_PRN:
    	{
    		...
    		/* Sine Waveform Range Table in other Mode */
    		else
    		{
	    		if( (model == TKAFG3K_VAL_MODEL_AFG3021) || (model == TKAFG3K_VAL_MODEL_AFG3022) ||
					(model == TKAFG3K_VAL_MODEL_AFG3021B) || (model == TKAFG3K_VAL_MODEL_AFG3022B))
                                                                  ...
                                                                  ViReal64 value)
{
	...
	dutyCycleHigh = 100*(period-0.8*(leadingTime+trailingTime))/period + 1.0e-14;
                                                                  ...
                                                                  ViReal64 value)
{
	...
	checkErr (Ivi_GetAttributeViInt32 (vi, VI_NULL, TKAFG3K_ATTR_OPERATION_MODE, 0, &operationMode));
                                                                  ...
                                                                  ViInt32 *value)
{
	...
	if (TKAFG3K_VAL_MODEL_AFG3021B == model)
		*value = AFG3021B_VAL_MAX_WFM_SIZE;
	else
...
/*- FSK Hop Frequency Range Table for SINE waveform -*/
static IviRangeTableEntry attrFSKHopSineFrequencyRangeTableEntries[] = 
{
        {0.01, AFG310X_VAL_MAX_FREQ_SINE, 0, "", 0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
static IviRangeTable attrFSKHopSineFrequencyRangeTable =
{
        IVI_VAL_RANGED,
        VI_TRUE,
        VI_TRUE,
        VI_NULL,
        attrFSKHopSineFrequencyRangeTableEntries,
};

/*- FSK Hop Frequency Range Table for SQUARE waveform -*/
static IviRangeTableEntry attrFSKHopSquareFrequencyRangeTableEntries[] =
{
		{0.01, AFG310X_VAL_MAX_FREQ_SQUARE, 0, "", 0},
		{IVI_RANGE_TABLE_LAST_ENTRY}
};
static IviRangeTable attrFSKHopSquareFrequencyRangeTable =
{
        IVI_VAL_RANGED,
        VI_TRUE,
        VI_TRUE,
        VI_NULL,
        attrFSKHopSquareFrequencyRangeTableEntries,
};

/*- FSK Hop Frequency Range Table for RAMP waveform -*/
static IviRangeTableEntry attrFSKHopRampFrequencyRangeTableEntries[] =
{
		{0.01, AFG310X_VAL_MAX_FREQ_RAMP, 0, "", 0},
		{IVI_RANGE_TABLE_LAST_ENTRY}
};
static IviRangeTable attrFSKHopRampFrequencyRangeTable =
{
        IVI_VAL_RANGED,
        VI_TRUE,
        VI_TRUE,
        VI_NULL,
        attrFSKHopRampFrequencyRangeTableEntries,
};

/*- FSK Hop Frequency Range Table for Default waveform -*/
static IviRangeTableEntry attrFSKHopDfltFrequencyRangeTableEntries[] =
{
        {0.01, AFG310X_VAL_MAX_FREQ_DEFAULT, 0, "", 0},			/*- 1mHz ~ 1MHz -*/
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
static IviRangeTable attrFSKHopDfltFrequencyRangeTable =
{
        IVI_VAL_RANGED,
        VI_TRUE,
        VI_TRUE,
        VI_NULL,
        attrFSKHopDfltFrequencyRangeTableEntries,
};

/*- FSK Hop Frequency Range Table for Arbitrary waveform -*/ 
static IviRangeTableEntry attrFSKHopArbFrequencyRangeTableEntries[] =
{
		{0.01, AFG310X_VAL_MAX_FREQ_ARB, 0, "", 0},
		{IVI_RANGE_TABLE_LAST_ENTRY}
};
static IviRangeTable attrFSKHopArbFrequencyRangeTable =
{
		IVI_VAL_RANGED,
        VI_TRUE,
        VI_TRUE,
        VI_NULL,
        attrFSKHopArbFrequencyRangeTableEntries,
};
                                                                        ...
                                                                        IviRangeTablePtr *rangeTablePtr)
{
	...
	switch(waveform)
	{
		case TKAFG3K_VAL_WFM_SINE:
		{
			tblPtr = &attrFSKHopSineFrequencyRangeTable;
			break;
		}
		case TKAFG3K_VAL_WFM_SQUARE:
		{
			tblPtr = &attrFSKHopSquareFrequencyRangeTable;
			break;
		}
		case TKAFG3K_VAL_WFM_RAMP:
		{
			tblPtr = &attrFSKHopRampFrequencyRangeTable;
			break;			
		}
		case TKAFG3K_VAL_WFM_SINC:
		case TKAFG3K_VAL_WFM_GAUS:
		...
		case TKAFG3K_VAL_WFM_HAV:
		{
			tblPtr = &attrFSKHopDfltFrequencyRangeTable;
			break;		
		}
		case TKAFG3K_VAL_WFM_USER1:
		case TKAFG3K_VAL_WFM_USER2:
		...
		case TKAFG3K_VAL_WFM_EDIT:
		{
			tblPtr = &attrFSKHopArbFrequencyRangeTable;
			break;		
		}
		case TKAFG3K_VAL_WFM_DC:
		case TKAFG3K_VAL_WFM_PRN:
...
static ViStatus tkafg3k_InitAttributes (ViSession vi, ViInt32 model)
{
    ViStatus    error = VI_SUCCESS;
    ViInt32     flags = 0;
    ViReal64    minLeadingEdgeTime, minTrailingEdgeTime;
...
static ViStatus tkafg3k_ConfigureModelDependantCallbacks (ViSession vi, ViInt32 model)
{
	...
	if(model == TKAFG3K_VAL_MODEL_AFG3021 || model == TKAFG3K_VAL_MODEL_AFG3021B)
	{
		/*- Output Mode -*/
	...
	else if(model == TKAFG3K_VAL_MODEL_AFG3252)
	{
		/*- Output Mode -*/
		tkafg3kAttrOutputMode_WriteCallback = AFG3XX2AttrOutputMode_WriteCallback;
		tkafg3kAttrOutputMode_ReadCallback = AFG3XX2AttrOutputMode_ReadCallback;		
