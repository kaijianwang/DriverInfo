/***************************************************************************** 
 *  2005-2013, National Instruments, Corporation.  All Rights Reserved.      * 
 *****************************************************************************/
...
static ViStatus _VI_FUNC tkafg3kAttrWaveform_CheckCallback (
	ViSession vi,
    ViConstString channelName,
    ViAttr attributeId,
    ViInt32 value);
...
static ViStatus tkafg3k_WfmExists (ViSession vi, ViInt32 wfmHandle, ViBoolean *wfmExists)
{
    ...
    {
        if(wfmHandle == TKAFG3K_VAL_WFM_EDIT || wfmHandle == TKAFG3K_VAL_WFM_EDIT2)
        {
            *wfmExists = VI_TRUE;
        }
        else
...
{
        {TKAFG3K_VAL_OUTPUT_EMEM1, 0, 0, "EMEM", 0},
                                                                       ...
                                                                       ViInt32 value)
{
    ...
    else
    {
        ...
        if((originalWaveform >= TKAFG3K_VAL_FIRST_WAVEFORM_HANDLE)
                                && (originalWaveform != TKAFG3K_VAL_WFM_EDIT && originalWaveform != TKAFG3K_VAL_WFM_EDIT2))
        {
            tkafg3k_WfmExists (vi, originalWaveform, &exists);
            if(!exists)
            {
				if ((!strcmp(channelName,CHAN2)) && (isModelC == VI_TRUE))
				{
					newWaveform = TKAFG3K_VAL_WFM_EDIT2;
				}
				else
				{
...
static IviRangeTableEntry attrArbWaveformHandleRangeTableEntries[] =
{
		...
		{TKAFG3K_VAL_WFM_EDIT2, 0, 0, "EMEM2", 0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
                                                                      ...
                                                                      ViInt32 value)
{
    ...
    if(value != TKAFG3K_VAL_WFM_EDIT && value != TKAFG3K_VAL_WFM_EDIT2)
    {
...
static IviRangeTableEntry attrAMInternalWaveformRangeTableEntries[] =
{
    ...
    {TKAFG3K_VAL_AM_INTERNAL_EMEM1, 0, 0, "EMEM", 0},
	{TKAFG3K_VAL_AM_INTERNAL_EMEM2, 0, 0, "EMEM2", 0},
    {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrFMInternalWaveformRangeTableEntries[] =
{
		...
		{TKAFG3K_VAL_FM_INTERNAL_EMEM1, 0, 0, "EMEM", 0},
		{TKAFG3K_VAL_FM_INTERNAL_EMEM2, 0, 0, "EMEM2", 0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrPMInternalWaveformRangeTableEntries[] =
{
		...
		{TKAFG3K_VAL_PM_INTERNAL_EMEM1, 0, 0, "EMEM", 0},
		{TKAFG3K_VAL_PM_INTERNAL_EMEM2, 0, 0, "EMEM2", 0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrPWMInternalWaveformRangeTableEntries[] =
{
		...
		{TKAFG3K_VAL_PWM_INTERNAL_EMEM1, 0, 0, "EMEM", 0},
		{TKAFG3K_VAL_PWM_INTERNAL_EMEM2, 0, 0, "EMEM2", 0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static ViStatus _VI_FUNC tkafg3kAttrWaveform_CheckCallback (ViSession vi,
                                                            ViConstString channelName,
                                                            ViAttr attributeId,
                                                            ViInt32 value)
{
		...
		(model == TKAFG3K_VAL_MODEL_AFG3022C))
	{
		...
		{
			if (strcmp(channelName,CHAN1))
			{
			    viCheckErrElab( IVI_ERROR_INVALID_CONFIGURATION, "The channel must be match edit memory");
			}   
		}
		else if (value == TKAFG3K_VAL_WFM_EDIT2)
		{
			if (strcmp(channelName,CHAN2))
			{
			    viCheckErrElab( IVI_ERROR_INVALID_CONFIGURATION, "The channel must be match edit memory");
			}  
		}
...
static ViStatus tkafg3k_InitAttributes (ViSession vi, ViInt32 model)
{
	...
	checkErr (Ivi_SetAttrCheckCallbackViInt32 (vi, TKAFG3K_ATTR_WAVEFORM,
