 ...
 *      [Xudong Yong] Mar 19, 2013 - Added functions:
 *                                   tkafg3k_ConfigureActiveMemory
 *									 tkafg3k_CopyWfmDataBetweenEditMemory
 *									 tkafg3k_SaveLoadWaveformData
 *									 tkafg3k_SetGetWaveformPointValue
 *								   - Added Attribute:
 *								     TKAFG3K_ATTR_ACTIVE_MEMORY
 *								   - Add option values for functions:
 *								     tkafg3k_ConfigureStandardWaveform
 *									 tkafg3k_ConfigureAMInternalByChannel
 *									 tkafg3k_ConfigureFMInternalByChannel
 *									 tkafg3k_ConfigurePMInternalByChannel
 *									 tkafg3k_ConfigurePWMInternalByChannel
 *      [Zhen Wang] Sep 13, 2013   - Modified the following range table.
 *	                                 attrActiveTwoMemoryRangeTableEntries
 * 		                               - Add TKAFG3K_VAL_OUTPUT_EMEM item
 *	                                 attrActiveOneMemoryRangeTableEntries
 *		                               - Replace TKAFG3K_VAL_OUTPUT_EMEM1 with TKAFG3K_VAL_OUTPUT_EMEM
 ...
 *		                               - Remove TKAFG3K_VAL_AM_INTERNAL_EMEM1 and TKAFG3K_VAL_AM_INTERNAL_EMEM2
 *		                               - Add TKAFG3K_VAL_AM_INTERNAL_EMEM
 *	                                 attrWaveformRangeTable
 *		                               - Remove TKAFG3K_VAL_WFM_EMEM2
 *                                 - Modified the following functions:
 *	                                 tkafg3k_ConfigureActiveMemory
 *		                               - Add TKAFG3K_VAL_OUTPUT_EMEM item for Active Memory ring control.
 *	                                 tkafg3k_SaveLoadWaveformData
 *	                                 tkafg3k_SetGetWaveformPointValue
 *  		                           - Add TKAFG3K_VAL_OUTPUT_EMEM item for Edit Memory ring control.
 *	                                 tkafg3k_ConfigureAMInternalByChannel
 *	                                 tkafg3k_ConfigureFMInternalByChannel
 *	                                 tkafg3k_ConfigurePMInternalByChannel
 *	                                 tkafg3k_ConfigurePWMInternalByChannel
 *		                               - Remove TKAFG3K_VAL_AM_INTERNAL_EMEM1 and TKAFG3K_VAL_AM_INTERNAL_EMEM2 from Modulation Waveform.
 *		                               - Add TKAFG3K_VAL_AM_INTERNAL_EMEM for Modulation Waveform.
 *	                                 tkafg3kAttrWaveform_CheckCallback
 *		                               - Remove from .c and .h file.
 *	                                 tkafg3kAttrOutputModeByChannel_WriteCallback
 *	                                 tkafg3k_WfmExists
 *		                               - Remove TKAFG3K_VAL_WFM_EMEM2 from the function.
 *                                 - Modified the following attributes:
 *	                                 TKAFG3K_ATTR_ACTIVE_MEMORY
 *                                     - Add TKAFG3K_VAL_OUTPUT_EMEM item
 *                                 - Removed declarations of the following range tables and repositioned the corresponding definitions to fix SDT 2013 crash issue:
 *								     attrAFG302XSineWfmSweepFrequencyRangeTable
 *                                   attrAFG310XSineWfmSweepFrequencyRangeTable
 *                                   attrAFG325XSineWfmSweepFrequencyRangeTable
 *                                   attrAFG3011SineWfmSweepFrequencyRangeTable
 *                                   attrAFG2021SineWfmSweepFrequencyRangeTable
 *                                   attrAFG305XSineWfmSweepFrequencyRangeTable
 *                                   attrAFG302XCSineWfmSweepFrequencyRangeTable
 *                                   attrAFG302XSquareWfmSweepFrequencyRangeTable
 *                                   attrAFG310XSquareWfmSweepFrequencyRangeTable
 *                                   attrAFG325XSquareWfmSweepFrequencyRangeTable
 *                                   attrAFG3011SquareWfmSweepFrequencyRangeTable
 *                                   attrAFG2021SquareWfmSweepFrequencyRangeTable
 *                                   attrAFG305XSquareWfmSweepFrequencyRangeTable
 *                                   attrAFG302XCSquareWfmSweepFrequencyRangeTable
 *                                   attrAFG302XRampWfmSweepFrequencyRangeTable
 *                                   attrAFG310XRampWfmSweepFrequencyRangeTable
 *                                   attrAFG325XRampWfmSweepFrequencyRangeTable
 *                                   attrAFG3011RampWfmSweepFrequencyRangeTable
 *                                   attrAFG2021RampWfmSweepFrequencyRangeTable
 *                                   attrAFG305XRampWfmSweepFrequencyRangeTable
 *                                   attrAFG302XCRampWfmSweepFrequencyRangeTable
 *                                   attrAFG302XDfltWfmSweepFrequencyRangeTable
 *                                   attrAFG310XDfltWfmSweepFrequencyRangeTable
 *                                   attrAFG325XDfltWfmSweepFrequencyRangeTable
 *                                   attrAFG3011DfltWfmSweepFrequencyRangeTable
 *                                   attrAFG2021DfltWfmSweepFrequencyRangeTable
 *                                   attrAFG305XDfltWfmSweepFrequencyRangeTable
 *                                   attrAFG302XCDfltWfmSweepFrequencyRangeTable
 *                                   attrAFG302XArbWfmSweepFrequencyRangeTable
 *                                   attrAFG310XArbWfmSweepFrequencyRangeTable
 *                                   attrAFG325XArbWfmSweepFrequencyRangeTable
 *                                   attrAFG3011ArbWfmSweepFrequencyRangeTable
 *                                   attrAFG2021ArbWfmSweepFrequencyRangeTable
 *                                   attrAFG305XArbWfmSweepFrequencyRangeTable
 *                                   attrAFG302XCArbWfmSweepFrequencyRangeTable
 *                                 - Added double quotes for File Name parameter in the following functions to fix command error:
 *                                   tkafg3k_SaveLoadWaveformData
 *                                   tkafg3k_SaveLoadInstrumentSettings
 *                                 - Moved the AFG3011C model comparison ahead of the AFG3011 model comparison in case of the model check error.
 *  [Chenchen Zhou] Feb 28, 2015   - Updated driver to comply with IVI-2014 generation.
 ******************************************************************************/
...
#define tkafg3k_GetCmdFromIntValue(value, table, cmd) \
                                    ...
                                    ViSession vi)
{
    ...
    if (!Ivi_Simulating(vi))
    {
        ...
        if (IDQuery)
        {
            ...
            if (strncmp (rdBuffer, VALID_RESPONSE_STRING_START_AFG3011C, strlen(VALID_RESPONSE_STRING_START_AFG3011C)) == 0 )
            {
                idQueryResult = VI_TRUE;
                model = TKAFG3K_VAL_MODEL_AFG3011C;
            }
			else if (strncmp (rdBuffer, VALID_RESPONSE_STRING_START_AFG3011, strlen(VALID_RESPONSE_STRING_START_AFG3011)) == 0 )
            {
                idQueryResult = VI_TRUE;
 ...
 *
 *           (2) After calling tkafg3k_close, you cannot use the instrument
 *               driver again until you call tkafg3k_init or
 *               tkafg3k_InitWithOptions.
 *****************************************************************************/
...
/*****************************************************************************
 * Function: tkafg3k_ConfigureActiveMemory
 * Purpose:  This function configures the active memory of the function
 *           generator.
 *
 *           Notes:
 *           (1) Only Edit Memory is available for AFG 3K, AFG 3KB and AFG
 *               3KC( firmware version is less than 1.0.4 ).
 *           (2) Edit Memory 2 is supported since AFG 3KC firmware version
 *               1.0.4 and only available on dual-channel models.
 *           (3) For AFG 3KC series, Edit Memory may represent Edit Memory 1
 *               or both Edit Memory 1 and Edit Memory 2 since firmware version
 *               1.0.4. Please refer to the corresponding function for detail.
 *****************************************************************************/
ViStatus _VI_FUNC tkafg3k_ConfigureActiveMemory(ViSession vi,
                                                ViInt32 activeMemory)
{
    return Ivi_SetAttributeViInt32 (vi, VI_NULL, TKAFG3K_ATTR_ACTIVE_MEMORY,
                                    IVI_VAL_DIRECT_USER_CALL, activeMemory);	
}
 ...
 *
 *           Notes:
 *           (1) You must set the output mode to TKAFG3K_VAL_OUTPUT_FUNC
 *               before calling this function.
 *
 *           (2) If the waveform parameter is set to TKAFG3K_VAL_WFM_DC, this
 *               function ignores the amplitude, frequency, and start phase
 *               parameters. If the waveform parameter is set to
 *               TKAFG3K_VAL_WFM_PRN, this function ignores the frequency and
 ...
 *
 *           Notes:
 *           (1) While using the function, make sure that set attribute value
 *               should agree with the following formulas:
 *
 ...
 *
 *           (2) Because the attributes set in this function can only be
 ...
 * 
 *           Notes:
 *           Because the attribute set in this function could only be
 *           operated correctly in PULSE waveform, the driver limits its
 *           accessibility to PULSE waveform. To ensure this function works,
 *           you should configure waveform shape to PULSE before using this
 *           function.
 ...
 *
 *           Notes:
 *           You must set the output mode to TKAFG3K_VAL_OUTPUT_ARB before
                                                       ...
                                                       ViInt32* wfmHandle)
{
    ...
    checkErr( tkafg3k_GetNewWfmInfo (vi, &newWfmHandle));
									   ...
									   tkafg3k_ClearArbWaveform (vi, 1001);
    if (!Ivi_Simulating(vi))                /* call only when locked */
    {
        ViSession   io = Ivi_IOSession(vi); /* call only when locked */
 ...
 *
 *           Notes:
 *           Although you have to specify a channel for this function, the
 *           value you set to Trigger Source will affect all channels of the
 *           instrument.
 *****************************************************************************/
 ...
 *               use tkafg3k_ConfigureOperationMode function and configure
 *               operation mode to TKAFG3K_VAL_OPERATE_BURST.
 *
 ...
 *           and sweep type.
 *
 *           When you use this function, be sure to meet the following
 *           formula.
 *           Sweep Time + Sweep Hold Time + Sweep Return Time <= 100 s
 *****************************************************************************/
 ...
 *
 *           Notes:
 *           You could add internal noise simultaneously with external signal
 *           if adding external signal is applicable.
 *****************************************************************************/
 ...
 *
 *           Notes:
 *           You could only use this function when operation mode is set to
 *           Continuous, Burst or Sweep mode.
 *****************************************************************************/
 ...
 *
 *           Notes:
 *           (1) This function is only applicable to AFG3100, AFG3200 series
 *               and AFG2021 function generator.
 *               Model       Applicable
 *               --------------------------
 *               AFG3021     NO
 *               AFG3022     NO
 ...
 *               AFG2021     CH1            YES
 *
 *           (3) You could add external signal simultaneously with internal
 *               noise if adding external signal is applicable.
 *****************************************************************************/
 ...
 *****************************************************************************/
ViStatus _VI_FUNC tkafg3k_viWrite (ViSession vi, ViByte buffer[], ViInt64 count, ViInt64 *returnCount)
{
    return Ivi_viWrite (vi, buffer, count, returnCount);
}
ViStatus _VI_FUNC tkafg3k_viRead (ViSession vi, ViInt64 bufferSize, ViByte buffer[], ViInt64 *returnCount)
{
 ...
 *                  Package (ICP) 4.6.1. You can use tkafg3k_viWrite
 *                  and tkafg3k_viRead instead.
 *****************************************************************************/
                                              ...
                                              ViReal64 wfmData[], ViInt32 wfmHandle )
{
	...
	checkErr( Ivi_GetAttributeViInt32 (vi, VI_NULL, TKAFG3K_ATTR_ACTIVE_MEMORY, 0, &activeMem) );
	checkErr( Ivi_GetAttrRangeTable (vi, VI_NULL, TKAFG3K_ATTR_ACTIVE_MEMORY, &table) );
	checkErr( tkafg3k_GetCmdFromIntValue(activeMem, table, &memoryName) ); 
                                                      ...
                                                      ViReal64 endPointData, ViInt32 wfmHandle)
{
    ...
    viCheckErr( viPrintf (io, "DATA:DEF %s,%d", memoryName, wfmSize) );                   /* Define the point number in edit memory */
    viCheckErr( viPrintf (io, "DATA:DATA:LINE %s,1,%d,%d,%d", memoryName, data1, wfmSize, data2) );   /* Write line data to the edit memory */
...
static ViStatus tkafg3k_WfmExists (ViSession vi, ViInt32 wfmHandle, ViBoolean *wfmExists)
{
    ...
    {
        if(wfmHandle == TKAFG3K_VAL_WFM_EMEM)
        {
            *wfmExists = VI_TRUE;
        }
        else
    ...
    if (!clearArbData)
    {
        ...
        if (!Ivi_Simulating(vi))
        {
            ...
            while(scanCnt)
            {
				...
				else if(strncmp(name, "EMEM1", TKAFG3K_VAL_NAME_LENGTH) == 0)
                {
                    continue;
                }
				else if(strncmp(name, "EMEM2", TKAFG3K_VAL_NAME_LENGTH) == 0)
                {
                    continue;
                }
                else
...
/*****************************************************************************
 * Function: tkafg3k_SaveLoadWaveformData
 * Purpose:  This function stores or loads the copied waveform data file from
 *           edit memory.
 *
 *           Notes:
 *           (1) This function is only supported by AFG3011C, AFG3021C,
 *               AFG3051C, AFG3052C, AFG3101C, AFG3102C, AFG3251C, AFG3252C,
 *               AFG3022C.
 *           (2) The file name parameter should have the extension .TFW.
 *           (3) Only TKAFG3K_VAL_OUTPUT_EMEM is available if AFG 3KC
 *               firmware versin is less than 1.0.4.
 *           (4) TKAFG3K_VAL_OUTPUT_EMEM2 is supported since AFG 3KC firmware
 *               version 1.0.4 and only available on dual-channel models.
 *           (5) In Save Waveform Data Operation, Edit Memory is the same as
 *               Edit Memory 1.
 *           (6) In Load Waveform Data Operation, Edit Memory stands for both
 *               Edit Memory 1 and Edit Memory 2.
 *****************************************************************************/
ViStatus _VI_FUNC   tkafg3k_SaveLoadWaveformData (ViSession vi, 
		                                          ViInt32 operationSelect,
												  ViConstString fileName,
												  ViInt32 editMemory)
{
    ...
    checkErr( Ivi_LockSession (vi, VI_NULL)); 
	checkErr( Ivi_GetAttrRangeTable (vi, VI_NULL, TKAFG3K_ATTR_ACTIVE_MEMORY, &table) ); 
	checkErr( tkafg3k_GetCmdFromIntValue(editMemory, table, &memoryName) );    
    checkErr( Ivi_GetAttributeViInt32 (vi, VI_NULL, TKAFG3K_ATTR_MODEL, 0, &model) );

    if(!((model == TKAFG3K_VAL_MODEL_AFG3011C) || (model == TKAFG3K_VAL_MODEL_AFG3021C) ||
         (model == TKAFG3K_VAL_MODEL_AFG3051C) || (model == TKAFG3K_VAL_MODEL_AFG3052C) ||
         (model == TKAFG3K_VAL_MODEL_AFG3101C) || (model == TKAFG3K_VAL_MODEL_AFG3102C) ||
         (model == TKAFG3K_VAL_MODEL_AFG3251C) || (model == TKAFG3K_VAL_MODEL_AFG3252C) ||
		 (model == TKAFG3K_VAL_MODEL_AFG3022C)))
    ...
    if (!Ivi_Simulating(vi))                /* call only when locked */
    {
        ...
        switch (operationSelect)
        {
            case TKAFG3K_VAL_WAVE_OPERATION_STORE:
                viCheckErr( viPrintf (io, "MMEM:STOR:TRAC %s,\"%s\"", memoryName, fileName)); 
                break;
            case TKAFG3K_VAL_WAVE_OPERATION_LOAD:
                viCheckErr( viPrintf (io, "MMEM:LOAD:TRAC %s,\"%s\"", memoryName, fileName)); 
                break;
            default:
                break;
        }
...
/*****************************************************************************
 * Function: tkafg3k_SetGetWaveformPointValue
 ...
 *****************************************************************************/
ViStatus _VI_FUNC   tkafg3k_SetGetWaveformPointValue (ViSession vi, 
		                                              ViInt32 pointIndex,
													  ViInt32 pointValue,
													  ViInt32 operationSelect,
													  ViInt32 editMemory,
...
/*****************************************************************************
 * Function: tkafg3k_CopyWfmDataBetweenEditMemory
 * Purpose: This function copied waveform data form one edit memory to another.
 *
 *          Notes:
 *          The function is only supported by double-channel models:
 *          AFG3052C, AFG3102C, AFG3252C, AFG3022C.
 *****************************************************************************/
ViStatus _VI_FUNC   tkafg3k_CopyWfmDataBetweenEditMemory (ViSession vi, 
														  ...
														  ViInt32 targetMemory)
{
    ...
    checkErr( Ivi_GetAttributeViInt32 (vi, VI_NULL, TKAFG3K_ATTR_MODEL, 0, &model) );
	checkErr( Ivi_GetAttrRangeTable (vi, VI_NULL, TKAFG3K_ATTR_ACTIVE_MEMORY, &table) ); 
	checkErr( tkafg3k_GetCmdFromIntValue(sourceMemory, table, &srcMem) );
	checkErr( tkafg3k_GetCmdFromIntValue(targetMemory, table, &dstMem) );
    
    if(!((model == TKAFG3K_VAL_MODEL_AFG3102C) ||
         (model == TKAFG3K_VAL_MODEL_AFG3252C) ||
		 (model == TKAFG3K_VAL_MODEL_AFG3052C) ||
		 (model == TKAFG3K_VAL_MODEL_AFG3022C)))
        
    {
        checkErr( IVI_ERROR_FUNCTION_NOT_SUPPORTED);   /* Only support double-channel models */
    }
    ...
    if (!Ivi_Simulating(vi))                /* call only when locked */
    {
        ...
        checkErr( Ivi_SetNeedToCheckStatus (vi, VI_TRUE));
		checkErr( viPrintf( io, "DATA:EMEMCOPY %s,%s", dstMem, srcMem));
    }
...
static IviRangeTableEntry attrActiveTwoMemoryRangeTableEntries[] =
	{
		{TKAFG3K_VAL_OUTPUT_EMEM, 0, 0, "EMEM", 0},
		{TKAFG3K_VAL_OUTPUT_EMEM1, 0, 0, "EMEM1", 0},
		{TKAFG3K_VAL_OUTPUT_EMEM2, 0, 0, "EMEM2", 0},
		{IVI_RANGE_TABLE_LAST_ENTRY}
	};

static IviRangeTable attrActiveTwoMemoryRangeTable =
	{
		IVI_VAL_DISCRETE,
        VI_FALSE,
        VI_FALSE,
                                                                       ...
                                                                       ViInt32 value)
{
    ...
    else
    {
        ...
        if((originalWaveform >= TKAFG3K_VAL_FIRST_WAVEFORM_HANDLE)
                                && (originalWaveform != TKAFG3K_VAL_WFM_EMEM ))
        {
            tkafg3k_WfmExists (vi, originalWaveform, &exists);
            if(!exists)
            {
				newWaveform = TKAFG3K_VAL_WFM_EMEM;
            }
            else
            {
...
static IviRangeTableEntry attrArbWaveformHandleRangeTableEntries[] =
{
        ...
        {TKAFG3K_VAL_WFM_EMEM,  0, 0, "EMEM",  0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrAMInternalWaveformRangeTableEntries[] =
{
    ...
    {TKAFG3K_VAL_AM_INTERNAL_EMEM, 0, 0, "EMEM", 0},
    {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrFMInternalWaveformRangeTableEntries[] =
{
		...
		{TKAFG3K_VAL_FM_INTERNAL_EMEM, 0, 0, "EMEM", 0},
        {IVI_RANGE_TABLE_LAST_ENTRY}
};
...
static IviRangeTableEntry attrPMInternalWaveformRangeTableEntries[] =
	{
		...
		{TKAFG3K_VAL_PM_INTERNAL_EMEM, 0, 0, "EMEM", 0},
		{IVI_RANGE_TABLE_LAST_ENTRY}
	};
...
static IviRangeTableEntry attrPWMInternalWaveformRangeTableEntries[] =
	{
		...
		{TKAFG3K_VAL_PWM_INTERNAL_EMEM, 0, 0, "EMEM", 0},
		{IVI_RANGE_TABLE_LAST_ENTRY}
	};
...
static ViStatus tkafg3k_InitAttributes (ViSession vi, ViInt32 model)
{
	...
	/*- Active Memory -*/
	if ((model == TKAFG3K_VAL_MODEL_AFG3052C) || (model == TKAFG3K_VAL_MODEL_AFG3102C) ||
		(model == TKAFG3K_VAL_MODEL_AFG3252C) || (model == TKAFG3K_VAL_MODEL_AFG3022C))
	{
	...
	checkErr (Ivi_AddAttributeViInt32 (vi, TKAFG3K_ATTR_ACTIVE_MEMORY,
	                                   "TKAFG3K_ATTR_ACTIVE_MEMORY",
	                                   TKAFG3K_VAL_OUTPUT_EMEM, IVI_VAL_ALWAYS_CACHE,
