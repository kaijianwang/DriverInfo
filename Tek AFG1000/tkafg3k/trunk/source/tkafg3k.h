...
#define TKAFG3K_MINOR_VERSION                7      /* Instrument driver minor version   */
...
#define TKAFG3K_VAL_OUTPUT_EMEM									(0L)
#define TKAFG3K_VAL_OUTPUT_EMEM1                                (1L)
#define TKAFG3K_VAL_OUTPUT_EMEM2                                (2L)
...
#define TKAFG3K_VAL_WFM_EMEM                                    (TKAFG3K_VAL_FIRST_WAVEFORM_HANDLE + 11)
...
#define TKAFG3K_VAL_AM_INTERNAL_EMEM                            (IVIFGEN_VAL_AM_INTERNAL_WFM_SPECIFIC_EXT_BASE + 6)  
...
#define TKAFG3K_VAL_FM_INTERNAL_EMEM                            (IVIFGEN_VAL_FM_INTERNAL_WFM_SPECIFIC_EXT_BASE + 6)
...
#define TKAFG3K_VAL_PM_INTERNAL_EMEM                            (204L)
...
#define TKAFG3K_VAL_PWM_INTERNAL_EMEM                           (204L)
 ...
 ****************************************************************************/
    ...
    ViStatus _VI_FUNC   tkafg3k_viWrite (ViSession vi, 
										 ViByte buffer[], 
										 ViInt64 count, 
										 ViInt64 *returnCount);
    ViStatus _VI_FUNC   tkafg3k_viRead (ViSession vi, 
										ViInt64 bufferSize, 
										ViByte buffer[], 
										ViInt64 *returnCount);
