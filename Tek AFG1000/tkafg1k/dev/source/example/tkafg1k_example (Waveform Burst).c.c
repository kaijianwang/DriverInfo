...
int main ()
{
    ...
    checkErr( tkafg1k_ConfigureStandardWaveform (tkafg1k, "1",
                                                 TKAFG1K_VAL_WFM_CARDIAC, 1.0, 0.0,
                                                 1000000.0, 0.0));
	
    /* Configure burst settings */
    checkErr( tkafg1k_ConfigureBurstCount (tkafg1k, "1", 5));
    checkErr( tkafg1k_ConfigureBurstMode (tkafg1k, "1", TKAFG1K_VAL_BURST_TRIGGER));
    checkErr( tkafg1k_ConfigureBurstEnabled (tkafg1k, "1", VI_TRUE));
